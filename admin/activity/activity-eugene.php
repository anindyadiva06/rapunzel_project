    ...
    <div class="container">
        <nav class="wrapper">
            ...
            <div class="main">
                ...
                <div class="content">
                   <h1>Activity Eugene</h1>
                   <div class="big-box">
                        <div class="box-1">
                            <div class="mini-box">
                                <div class="img">
                                    <img src="activity (5).png">
                                </div>
                                <div class="act">
                                    <p>Eugene mencuri tiara rapunzel yang terpajang di kerajaan</p>
                        ...
                        <div class="box-1">
                                <div class="mini-box">
                                    <div class="img">
                                        <img src="activity (6).png">
                                    </div>
                                    <div class="act">
                                        <p>Eugene mengajak Rapunzel untuk menjelajahi dunia luar</p>
                                        <button class="edit"><a href="edit-act.html">Edit</a></button>
                                    </div>
                                </div>
                        </div>
                   ...
                   <div class="big-box">
                    <div class="box-1">
                        <div class="mini-box">
                            <div class="img">
                                <img src="activity (7).png">
                            </div>
                            <div class="act">
                                <p>Eugene tak sengaja bertemu dengan Rapunzel saat bersembunyi dari prajurit</p>
                                <button class="edit"><a href="edit-act.html">Edit</a></button>
                            </div>
                        </div>
                    </div>
                    <div class="box-1">
                            <div class="mini-box">
                                <div class="img">
                                    <img src="activity (8).png">
                                </div>
                                <div class="act">
                                    <p>Eugene memotong rambut Rapunzel untuk menyelematkannya</p>
                                    <button class="edit"><a href="edit-act.html">Edit</a></button>
                                </div>
                            </div>
                    </div>
